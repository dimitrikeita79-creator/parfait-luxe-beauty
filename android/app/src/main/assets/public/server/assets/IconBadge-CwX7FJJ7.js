...
//#region src/components/IconBadge.tsx
var TONES = {
	neutral: {
		color: "oklch(0.32 0.01 60)",
		glow: "oklch(0.85 0.05 85 / 0.45)"
	},
	gold: {
		color: "oklch(0.55 0.12 80)",
		glow: "oklch(0.85 0.12 85 / 0.55)"
	},
	green: {
		color: "#25D366",
...
*/
function IconBadge({ icon: Icon, size = "md", tone = "neutral", className = "" }) {
	const t = TONES[tone];
	const s = SIZES[size];
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", {
			...
			style: { background: `radial-gradient(60% 40% at 30% 20%, oklch(1 0 0 / 0.9), transparent 70%)` }
		}), /* @__PURE__ */ jsx(Icon, {
