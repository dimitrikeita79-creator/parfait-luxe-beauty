-- ============================================================
-- Script corrigé pour configurer les avis et avatars
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.reviews (
  ...
  "text" TEXT NOT NULL,  -- Guillemets pour éviter le conflit avec le type TEXT
...
BEGIN
    ...
    -- Renommer la colonne "text" si elle existe sans guillemets
    IF EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_name = 'reviews' 
        ...
        RAISE NOTICE 'Colonne text existe déjà';
    END IF;
END $$;
...
-- Utiliser "text" avec guillemets car c'est un nom de colonne
